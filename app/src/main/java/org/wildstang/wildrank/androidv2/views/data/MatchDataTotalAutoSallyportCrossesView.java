...
public class MatchDataTotalAutoSallyportCrossesView extends MatchDataView implements IMatchDataView {

    public MatchDataTotalAutoSallyportCrossesView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void calculateFromDocuments(List<Document> documents) {
        ...
        Observable foulsObservable = Observable.from(documents)
                ...
                .map(data -> data.get("auto-sallyport"))
