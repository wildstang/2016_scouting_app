...
public class MatchDataTotalAutoMoatCrossesView extends MatchDataView implements IMatchDataView {

    public MatchDataTotalAutoMoatCrossesView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
