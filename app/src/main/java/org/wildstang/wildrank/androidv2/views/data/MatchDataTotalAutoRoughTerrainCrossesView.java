...
public class MatchDataTotalAutoRoughTerrainCrossesView extends MatchDataView implements IMatchDataView {

    public MatchDataTotalAutoRoughTerrainCrossesView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void calculateFromDocuments(List<Document> documents) {
        ...
        Observable foulsObservable = Observable.from(documents)
                ...
                .map(data -> data.get("auto-roughTerrain"))
