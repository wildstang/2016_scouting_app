...
public class MatchDataTotalAutoLowBarCrossesView extends MatchDataView implements IMatchDataView {

    public MatchDataTotalAutoLowBarCrossesView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
