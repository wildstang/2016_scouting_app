...
//                .flatMap(data -> Observable.from((List<Map<String, Object>>) data.get("matches")))
//                .map(stack -> {
//                    boolean preexisting = (boolean) stack.get(MatchModel.PREEXISTING_KEY);
//                    int preexistingHeight = (int) stack.get(MatchModel.PREEXISTING_HEIGHT_KEY);
//                    int toteCount = (int) stack.get(MatchModel.TOTE_COUNT_KEY);
//                    int height;
//                    if (preexisting) {
