...
public class MatchDataTotalAutoQuadRampCrossesView extends MatchDataView implements IMatchDataView {

    public MatchDataTotalAutoQuadRampCrossesView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void calculateFromDocuments(List<Document> documents) {
        ...
        Observable foulsObservable = Observable.from(documents)
                ...
                .map(data -> data.get("auto-quadRamp"))
